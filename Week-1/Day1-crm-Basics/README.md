...
->This technology allows you to manage relationships with your customers and prospects.

->Also USed to track data related to all of your interactions. 
...
->Contact: A person related to the account
...
->Lead = Student who showed interest to fill the form

->Opportunity = Student applying for admission

->Customer = Student who got admitted
